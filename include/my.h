...
void pf_int(int *printed_chars, va_list list, char *flags);
void pf_u(int *printed_chars, va_list list, char *flags);
...
void pf_majs(int *printed_chars, va_list list, char *flags);
